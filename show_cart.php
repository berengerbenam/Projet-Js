...
$output = " ";
  ...
  while ($row = mysqli_fetch_array($res)) {
  	 ...
  	 $output .= "<div class='col-md-3 shadow-sm'>
        ...
        <h5 class='text-center'>".$row['price']." &nbspFCFA</h5>
        ...
        <input type='submit' name='add_to_cart' class='btn btn-warning my-2 add' value='AJOUT_PANIER' id='".$row['id']."' style='margin-left:55px;'>
